...
{"0": {
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/mplab_harmony_license.html",
    "relUrl": "/mplab_harmony_license.html"
  },"1": {
    "doc": "I2C driver asynchronous - I2C Temp Sensor",
    "title": "I2C driver asynchronous - I2C Temp Sensor",
    "content": "This example application shows how to use the I2C driver in asynchronous mode to communicate with the MCP9808 I2C based temperature sensor. ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c/async/i2c_temp_sensor/readme.html#i2c-driver-asynchronous---i2c-temp-sensor",
    "relUrl": "/apps/driver/i2c/async/i2c_temp_sensor/readme.html#i2c-driver-asynchronous---i2c-temp-sensor"
  },"2": {
    "doc": "I2C driver asynchronous - I2C Temp Sensor",
    "title": "Description",
    "content": "This example uses the I2C driver in asynchronous mode to communicate with the MCP9808 I2C temperature sensor. The example application reads and prints the temperature value on a serial terminal whenever a user presses a switch on the development board. ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c/async/i2c_temp_sensor/readme.html#description",
    "relUrl": "/apps/driver/i2c/async/i2c_temp_sensor/readme.html#description"
  },"3": {
    "doc": "I2C driver asynchronous - I2C Temp Sensor",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/driver/i2c/async/i2c_temp_sensor/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | pic32mk_mcj_curiosity_pro.X | MPLABX project for PIC32MK MCJ Curiosity Pro Board | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c/async/i2c_temp_sensor/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/i2c/async/i2c_temp_sensor/readme.html#downloading-and-building-the-application"
  },"4": {
    "doc": "I2C driver asynchronous - I2C Temp Sensor",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mk_mcj_curiosity_pro.X | PIC32MK MCJ Curiosity Pro Board | . |   |   | . Setting up PIC32MK MCJ Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer | This will enumerate as a COM port on the PC | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c/async/i2c_temp_sensor/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/i2c/async/i2c_temp_sensor/readme.html#setting-up-the-hardware"
  },"5": {
    "doc": "I2C driver asynchronous - I2C Temp Sensor",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application using its IDE | Press the User Switch to read and print the temperature value on the serial terminal. The temperature values will be displayed on the terminal as shown below: . | . Refer to the following table for Switch name: . | Board | Switch Name | . | PIC32MK MCJ Curiosity Pro Board | SW200 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c/async/i2c_temp_sensor/readme.html#running-the-application",
    "relUrl": "/apps/driver/i2c/async/i2c_temp_sensor/readme.html#running-the-application"
  },"6": {
    "doc": "I2C driver asynchronous - I2C Temp Sensor",
    "title": "I2C driver asynchronous - I2C Temp Sensor",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c/async/i2c_temp_sensor/readme.html",
    "relUrl": "/apps/driver/i2c/async/i2c_temp_sensor/readme.html"
  },"7": {
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c/sync/i2c_eeprom/readme.html#i2c-driver-synchronous---i2c-eeprom",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#i2c-driver-synchronous---i2c-eeprom"
  },"8": {
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "Description",
    "content": "This example uses the I2C driver in synchronous mode to communicate with the EEPROM to perform write and read operations in FreeRTOS environment. This application uses I2C driver to read and write data from an AT24CM02 EEPROM device. ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c/sync/i2c_eeprom/readme.html#description",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#description"
  },"9": {
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/driver/i2c/sync/i2c_eeprom/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | pic32mk_mcj_curiosity_pro_freertos.X | MPLABX project for PIC32MK MCJ Curiosity Pro Board | . | pic32mk_mcm_curiosity_pro_freertos.X | MPLABX project for PIC32MK MCM Curiosity Pro Board | . | pic32mk_mca_curiosity_pro_freertos.X | MPLABX project for PIC32MK MCA Curiosity Pro Board | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c/sync/i2c_eeprom/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#downloading-and-building-the-application"
  },"10": {
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mk_mcm_curiosity_pro_freertos.X | PIC32MK MCM Curiosity Pro Board | . | pic32mk_mcj_curiosity_pro_freertos.X | PIC32MK MCJ Curiosity Pro Board | . | pic32mk_mca_curiosity_pro_freertos.X | PIC32MK MCA Curiosity Pro Board | . |   |   | . | To run the demo, the following additional hardware are required: . | One EEPROM 3 Click board | . | . Setting up PIC32MK MCJ Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer | Install the EEPROM 3 Click board on to the mikroBUS Xplained Pro board | Connect the mikroBUS Xplained Pro board to the EXT1 header (J501) of the PIC32MK MCJ Curiosity Pro Development Board | . Setting up PIC32MK MCM Curiosity Pro Board . | Connect a micro USB cable to the USB DEBUG port J500 | Install the EEPROM 3 Click board on to the mikroBUS socket J300 of PIC32MK MCM Curiosity Pro Development Board | . Setting up PIC32MK MCA Curiosity Pro Board . | Connect a micro USB cable to the USB DEBUG port | Install the EEPROM 3 Click board on to the mikroBUS socket of PIC32MK MCA Curiosity Pro Development Board | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c/sync/i2c_eeprom/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#setting-up-the-hardware"
  },"11": {
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON when the value read from the EEPROM matched with the written value | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MK MCJ Curiosity Pro Board | LED2 | . | PIC32MK MCM Curiosity Pro Board | LED2 | . | PIC32MK MCA Curiosity Pro Board | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c/sync/i2c_eeprom/readme.html#running-the-application",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#running-the-application"
  },"12": {
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "I2C driver synchronous - I2C EEPROM",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c/sync/i2c_eeprom/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#i2c-eeprom-at24-driver---eeprom-read-write",
    "relUrl": "/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#i2c-eeprom-at24-driver---eeprom-read-write"
  },"14": {
    "doc": "I2C EEPROM AT24 driver - EEPROM Read Write",
    "title": "Description",
    "content": ". | This example uses the AT24 driver to communicate with I2C based External AT24CM0 series EEPROMs to perform write and read operations in Bare-Metal environment. | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#downloading-and-building-the-application"
  },"16": {
    "doc": "I2C EEPROM AT24 driver - EEPROM Read Write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mk_mcj_curiosity_pro.X | PIC32MK MCJ Curiosity Pro Board | . | pic32mk_mca_curiosity_pro.X | PIC32MK MCA Curiosity Pro Board | . |   |   | . | To run the demo, the following additional hardware are required: . | One EEPROM 3 Click board | . | . Setting up PIC32MK MCJ Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer | Install the EEPROM 3 Click board on to the mikroBUS Xplained Pro board | Connect the mikroBUS Xplained Pro board to the EXT1 header (J501) of the PIC32MK MCJ Curiosity Pro Development Board | . Setting up PIC32MK MCA Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer | Install the EEPROM 3 Click board on to the mikroBUS connector of the PIC32MK MCA Curiosity Pro Development Board | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#setting-up-the-hardware"
  },"17": {
    "doc": "I2C EEPROM AT24 driver - EEPROM Read Write",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON when the data read from EEPROM matches with the written data | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MK MCJ Curiosity Pro Board | LED2 | . | PIC32MK MCA Curiosity Pro Board | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#running-the-application",
    "relUrl": "/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#running-the-application"
  },"18": {
    "doc": "I2C EEPROM AT24 driver - EEPROM Read Write",
    "title": "I2C EEPROM AT24 driver - EEPROM Read Write",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/async/spi_multi_instance/readme.html#spi-driver-asynchronous---multi-instance",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/async/spi_multi_instance/readme.html#description",
    "relUrl": "/apps/driver/spi/async/spi_multi_instance/readme.html#description"
  },"21": {
    "doc": "SPI Driver asynchronous - multi instance",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/driver/spi/async/spi_multi_instance/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | pic32mk_mcm_curiosity_pro.X | MPLABX project for PIC32MK MCM Curiosity Pro Board | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/async/spi_multi_instance/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/spi/async/spi_multi_instance/readme.html#downloading-and-building-the-application"
  },"22": {
    "doc": "SPI Driver asynchronous - multi instance",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mk_mcm_curiosity_pro.X | PIC32MK MCM Curiosity Pro Board | . |   |   | . | To run the demo, the following additional hardware are required: . | Two EEPROM 4 Click boards | . | . Setting up PIC32MK MCM Curiosity Pro Board . | Connect a micro USB cable to the USB DEBUG port J500 | Install two EEPROM 4 Click boards on to the two mikroBUS sockets (J300 and J301) of PIC32MK MCM Curiosity Pro Board | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/async/spi_multi_instance/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/spi/async/spi_multi_instance/readme.html#setting-up-the-hardware"
  },"23": {
    "doc": "SPI Driver asynchronous - multi instance",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON when the data read from the EEPROMs matches with the data written to the EEPROMs | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MK MCM Curiosity Pro Board | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/async/spi_multi_instance/readme.html#running-the-application",
    "relUrl": "/apps/driver/spi/async/spi_multi_instance/readme.html#running-the-application"
  },"24": {
    "doc": "SPI Driver asynchronous - multi instance",
    "title": "SPI Driver asynchronous - multi instance",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/async/spi_multi_instance/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/async/spi_multi_slave/readme.html#spi-driver-asynchronous---multi-slave",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/async/spi_multi_slave/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/async/spi_multi_slave/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/spi/async/spi_multi_slave/readme.html#downloading-and-building-the-application"
  },"28": {
    "doc": "SPI Driver asynchronous - multi slave",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mk_mcj_curiosity_pro.X | PIC32MK MCJ Curiosity Pro Board | . | pic32mk_mca_curiosity_pro.X | PIC32MK MCA Curiosity Pro Board | . |   |   | . | To run the demo, the following additional hardware are required: . | Two EEPROM 4 Click boards | Two mikroBUS Xplained Pro boards | . | . Setting up PIC32MK MCJ Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer | Install EEPROM 4 Click boards on to the mikroBUS Xplained Pro boards | Connect mikroBUS Xplained Pro boards on to the “EXT1” (J501) and “EXT2” (J502) headers of the PIC32MK MCJ Curiosity Pro Development Board | . Setting up PIC32MK MCA Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer | Install one EEPROM 4 Click board on to the mikroBUS socket of PIC32MK MCA Curiosity Pro Development Board | Install another EEPROM 4 Click board on to the mikroBUS Xplained Pro board | Connect mikroBUS Xplained Pro board on to the “EXT1” (J501) header of the PIC32MK MCA Curiosity Pro Development Board | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/async/spi_multi_slave/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/spi/async/spi_multi_slave/readme.html#setting-up-the-hardware"
  },"29": {
    "doc": "SPI Driver asynchronous - multi slave",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED turns ON when the data read from the EEPROMs matches with the data written to the EEPROMs | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MK MCJ Curiosity Pro Board | LED2 | . | PIC32MK MCA Curiosity Pro Board | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/async/spi_multi_slave/readme.html#running-the-application",
    "relUrl": "/apps/driver/spi/async/spi_multi_slave/readme.html#running-the-application"
  },"30": {
    "doc": "SPI Driver asynchronous - multi slave",
    "title": "SPI Driver asynchronous - multi slave",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/async/spi_multi_slave/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#spi-driver-asynchronous---self-loopback-multi-client",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#downloading-and-building-the-application"
  },"34": {
    "doc": "SPI Driver asynchronous - Self loopback multi client",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mk_mcj_curiosity_pro.X | PIC32MK MCJ Curiosity Pro Board | . | pic32mk_gp_db.X | PIC32MK GP Development Kit | . |   |   | . Setting up PIC32MK GP Development Kit . | Connect micro USB cable to the ‘Debug USB’ connector(J12) on the board to the computer | Use jumper wire to Connect MOSI and MISO lines of J1 connector . | SPI6 MOSI signal is mapped to RB0 | SPI6 MISO signal is mapped to RG9 | . | . Setting up PIC32MK MCJ Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer | Use jumper wire to connect “Pin 16 of J501 header” to “Pin 17 of J501 header” . | SDI2 is mapped to RD6 that is routed to “Pin 17 of J501 header” | SDO2 is mapped to RC7 that is routed to “Pin 16 of J501 header” | . | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#setting-up-the-hardware"
  },"35": {
    "doc": "SPI Driver asynchronous - Self loopback multi client",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON on Success | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MK GP Development Kit | LED2 | . | PIC32MK MCJ Curiosity Pro Board | LED2 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#running-the-application",
    "relUrl": "/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#running-the-application"
  },"36": {
    "doc": "SPI Driver asynchronous - Self loopback multi client",
    "title": "SPI Driver asynchronous - Self loopback multi client",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#spi-driver-synchronous---self-loopback-multi-client",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#description",
    "relUrl": "/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#description"
  },"39": {
    "doc": "SPI Driver synchronous - Self loopback multi client",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/driver/spi/sync/spi_self_loopback_multi_client/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | pic32mk_gp_db_freertos.X | MPLABX project for PIC32MK GP Development Kit | . | pic32mk_mcj_curiosity_pro_freertos.X | MPLABX project for PIC32MK MCJ Curiosity Pro Board | . | pic32mk_mcm_curiosity_pro_freertos.X | MPLABX project for PIC32MK MCM Curiosity Pro Board | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#downloading-and-building-the-application"
  },"40": {
    "doc": "SPI Driver synchronous - Self loopback multi client",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mk_mcm_curiosity_pro_freertos.X | PIC32MK MCM Curiosity Pro Board | . | pic32mk_mcj_curiosity_pro_freertos.X | PIC32MK MCJ Curiosity Pro Board | . | pic32mk_gp_db_freertos.X | PIC32MK GP Development Kit | . |   |   | . Setting up PIC32MK GP Development Kit . | Connect micro USB cable to the ‘Debug USB’ connector(J12) on the board to the computer | Use jumper wire to Connect MOSI and MISO lines of J1 connector . | SPI6 MOSI signal is mapped to RB0 | SPI6 MISO signal is mapped to RG9 | . | . Setting up PIC32MK MCJ Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer | Use jumper wire to connect “Pin 16 of J501 header” to “Pin 17 of J501 header” . | SDI2 is mapped to RD6 that is routed to “Pin 17 of J501 header” | SDO2 is mapped to RC7 that is routed to “Pin 16 of J501 header” | . | . Setting up PIC32MK MCM Curiosity Pro Board . | Connect a micro USB cable to the USB DEBUG port J500 | Use jumper wire to connect Pin 5 to Pin 6 of mikroBUS header (J300) . | SDI6 is mapped to RG9 that is routed to Pin 5 of mikroBUS header | SDO6 is mapped to RB0 that is routed to Pin 6 of mikroBUS header | . | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#setting-up-the-hardware"
  },"41": {
    "doc": "SPI Driver synchronous - Self loopback multi client",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON on Success | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MK GP Development Kit | LED2 | . | PIC32MK MCJ Curiosity Pro Board | LED2 | . | PIC32MK MCM Curiosity Pro Board | LED2 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#running-the-application",
    "relUrl": "/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#running-the-application"
  },"42": {
    "doc": "SPI Driver synchronous - Self loopback multi client",
    "title": "SPI Driver synchronous - Self loopback multi client",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#spi-eeprom-at25-driver---eeprom-read-write",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#description",
    "relUrl": "/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#description"
  },"45": {
    "doc": "SPI EEPROM AT25 driver - EEPROM Read Write",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/driver/spi_eeprom/at25/at25_eeprom_read_write/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | pic32mk_gp_db.X | MPLABX project for PIC32MK GP Development Kit | . | pic32mk_mcj_curiosity_pro.X | MPLABX project for PIC32MK MCJ Curiosity Pro Board | . | pic32mk_mca_curiosity_pro.X | MPLABX project for PIC32MK MCA Curiosity Pro Board | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#downloading-and-building-the-application"
  },"46": {
    "doc": "SPI EEPROM AT25 driver - EEPROM Read Write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mk_mcj_curiosity_pro.X | PIC32MK MCJ Curiosity Pro Board | . | pic32mk_mca_curiosity_pro.X | PIC32MK MCA Curiosity Pro Board | . | pic32mk_gp_db.X | PIC32MK GP Development Kit | . |   |   | . | To run the demo, the following additional hardware are required: . | One EEPROM 4 Click board | . | . Setting up PIC32MK GP Development Kit . | Connect micro USB cable to the ‘Debug USB’ connector(J12) on the board to the computer | Install EEPROM 4 Click board on to the J1 click board slot provided on PIC32MK GP Development Kit | . Setting up PIC32MK MCJ Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer | Install EEPROM 4 Click board on to the mikroBUS Xplained Pro board | Connect mikroBUS Xplained Pro board on to the “EXT1” header (J501) of the PIC32MK MCJ Curiosity Pro Development Board | . Setting up PIC32MK MCA Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer | Install EEPROM 4 Click board on to the mikroBUS connector of the PIC32MK MCA Curiosity Pro Development Board | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#setting-up-the-hardware"
  },"47": {
    "doc": "SPI EEPROM AT25 driver - EEPROM Read Write",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON when the value read from EEPROM matches with the written data | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MK GP Development Kit | LED2 | . | PIC32MK MCJ Curiosity Pro Board | LED2 | . | PIC32MK MCA Curiosity Pro Board | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#running-the-application",
    "relUrl": "/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#running-the-application"
  },"48": {
    "doc": "SPI EEPROM AT25 driver - EEPROM Read Write",
    "title": "SPI EEPROM AT25 driver - EEPROM Read Write",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/usart/async/usart_echo/readme.html#usart-driver-asynchronous---usart-echo",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/usart/async/usart_echo/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/usart/async/usart_echo/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/usart/async/usart_echo/readme.html#downloading-and-building-the-application"
  },"52": {
    "doc": "USART driver asynchronous - USART echo",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mk_mcm_curiosity_pro.X | PIC32MK MCM Curiosity Pro Board | . | pic32mk_mcj_curiosity_pro.X | PIC32MK MCJ Curiosity Pro Board | . | pic32mk_mca_curiosity_pro.X | PIC32MK MCA Curiosity Pro Board | . | pic32mk_gp_db.X | PIC32MK GP Development Kit | . |   |   | . Setting up PIC32MK GP Development Kit . | Connect micro USB cable to the ‘Debug USB’ connector(J12) on the board to the computer | Connect a micro USB cable to the USART-USB port J25. This will enumerate as a COM port on the PC | . Setting up PIC32MK MCJ Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer. This will enumerate as a COM port on the PC | . Setting up PIC32MK MCM Curiosity Pro Board . | Connect a micro USB cable to the USB DEBUG port J500 | Connect a micro USB cable to the USB to UART port J400. This will enumerate as a COM port on the PC | . Setting up PIC32MK MCA Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer. This will enumerate as a COM port on the PC | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/usart/async/usart_echo/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/usart/async/usart_echo/readme.html#setting-up-the-hardware"
  },"53": {
    "doc": "USART driver asynchronous - USART echo",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application using its IDE | Type a character and observe the output on the console as shown below: . | LED toggles each time the character is echoed | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MK GP Development Kit | LED1 | . | PIC32MK MCJ Curiosity Pro Board | LED1 | . | PIC32MK MCM Curiosity Pro Board | LED2 | . | PIC32MK MCA Curiosity Pro Board | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/usart/async/usart_echo/readme.html#running-the-application",
    "relUrl": "/apps/driver/usart/async/usart_echo/readme.html#running-the-application"
  },"54": {
    "doc": "USART driver asynchronous - USART echo",
    "title": "USART driver asynchronous - USART echo",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/usart/async/usart_echo/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/usart/async/usart_multi_instance/readme.html#usart-driver-asynchronous---usart-multi-instance",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/usart/async/usart_multi_instance/readme.html#description",
    "relUrl": "/apps/driver/usart/async/usart_multi_instance/readme.html#description"
  },"57": {
    "doc": "USART driver asynchronous - USART multi instance",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/driver/usart/async/usart_multi_instance/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | pic32mk_gp_db.X | MPLABX project for PIC32MK GP Development Kit | . | pic32mk_mca_curiosity_pro.X | MPLABX project for PIC32MK MCA Curiosity Pro Board | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/usart/async/usart_multi_instance/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/usart/async/usart_multi_instance/readme.html#downloading-and-building-the-application"
  },"58": {
    "doc": "USART driver asynchronous - USART multi instance",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mk_gp_db.X | PIC32MK GP Development Kit | . | pic32mk_mca_curiosity_pro.X | PIC32MK MCA Curiosity Pro Board | . |   |   | . | To run the demo, the following additional hardware are required: . | USB UART click board | . | . Setting up PIC32MK GP Development Kit . | Connect micro USB cable to the ‘Debug USB’ connector(J12) on the board to the computer | Connect a micro USB cable to the USART-USB port J25. This will enumerate the first COM port | Install an USB UART click board on to the mikroBUS socket J1 | Connect mini USB cable to the USB UART click board. This will enumerate the second COM port | . Setting up PIC32MK MCA Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer. This will enumerate as first COM port on the PC | Install an USB UART click board on to the mikroBUS socket | Connect mini USB cable to the USB UART click board. This will enumerate the second COM port | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/usart/async/usart_multi_instance/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/usart/async/usart_multi_instance/readme.html#setting-up-the-hardware"
  },"59": {
    "doc": "USART driver asynchronous - USART multi instance",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application using its IDE | Type a character and observe the output on the two consoles as shown below: . | If success the character typed echoes back and an LED toggles on each time the character is echoed | Console 1 | . | Console 2 | . | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MK GP Development Kit | LED1 | . | PIC32MK MCA Curiosity Pro Board | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/usart/async/usart_multi_instance/readme.html#running-the-application",
    "relUrl": "/apps/driver/usart/async/usart_multi_instance/readme.html#running-the-application"
  },"60": {
    "doc": "USART driver asynchronous - USART multi instance",
    "title": "USART driver asynchronous - USART multi instance",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/usart/async/usart_multi_instance/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/usart/sync/usart_echo/readme.html#usart-driver-synchronous---usart-echo",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/usart/sync/usart_echo/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/usart/sync/usart_echo/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#downloading-and-building-the-application"
  },"64": {
    "doc": "USART driver synchronous - USART echo",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mk_mcm_curiosity_pro_freertos.X | PIC32MK MCM Curiosity Pro Board | . | pic32mk_mcj_curiosity_pro_freertos.X | PIC32MK MCJ Curiosity Pro Board | . | pic32mk_mca_curiosity_pro_freertos.X | PIC32MK MCA Curiosity Pro Board | . |   |   | . Setting up PIC32MK MCJ Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer. This will enumerate as a COM port on the PC | . Setting up PIC32MK MCM Curiosity Pro Board . | Connect a micro USB cable to the USB DEBUG port J500 | Connect a micro USB cable to the USB to UART port J400. This will enumerate as a COM port on the PC | . Setting up PIC32MK MCA Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer. This will enumerate as a COM port on the PC | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/usart/sync/usart_echo/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#setting-up-the-hardware"
  },"65": {
    "doc": "USART driver synchronous - USART echo",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application using its IDE | Type a character and observe the output on the console as shown below: . | LED toggles each time the character is echoed | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MK MCJ Curiosity Pro Board | LED2 | . | PIC32MK MCM Curiosity Pro Board | LED2 | . | PIC32MK MCA Curiosity Pro Board | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/usart/sync/usart_echo/readme.html#running-the-application",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#running-the-application"
  },"66": {
    "doc": "USART driver synchronous - USART echo",
    "title": "USART driver synchronous - USART echo",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/usart/sync/usart_echo/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/fs/nvm_fat/readme.html#fat-filesystem-using-nvm-media",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/fs/nvm_fat/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/fs/nvm_fat/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/fs/nvm_fat/readme.html#downloading-and-building-the-application"
  },"70": {
    "doc": "FAT filesystem using NVM Media",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mk_mcm_curiosity_pro.X | PIC32MK MCM Curiosity Pro Board | . | pic32mk_mca_curiosity_pro.X | PIC32MK MCA Curiosity Pro Board | . | pic32mk_gp_db.X | PIC32MK GP Development Kit | . |   |   | . Setting up PIC32MK GP Development Kit . | Connect micro USB cable to the ‘Debug USB’ connector(J12) on the board to the computer | . Setting up PIC32MK MCM Curiosity Pro Board . | Connect a micro USB cable to the USB DEBUG port J500 | . Setting up PIC32MK MCA Curiosity Pro Board . | Connect a micro USB cable to the USB DEBUG port | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/fs/nvm_fat/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/fs/nvm_fat/readme.html#setting-up-the-hardware"
  },"71": {
    "doc": "FAT filesystem using NVM Media",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | Press Switch to start the file operations | The LED is turned ON when the File FILE.TXT has the app data “Hello World” written in it | . Refer to the following table for switch and LED name: . | Board | Switch name | LED Name | . | PIC32MK GP Development Kit | S1 | LED3 | . | PIC32MK MCM Curiosity Pro Board | SW1 | LED2 | . | PIC32MK MCA Curiosity Pro Board | SW200 | LED1 | . |   |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/fs/nvm_fat/readme.html#running-the-application",
    "relUrl": "/apps/fs/nvm_fat/readme.html#running-the-application"
  },"72": {
    "doc": "FAT filesystem using NVM Media",
    "title": "FAT filesystem using NVM Media",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/fs/nvm_fat/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/fs/sdspi_fat/readme.html#fat-filesystem-using-sdspi-media",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/fs/sdspi_fat/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/fs/sdspi_fat/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/fs/sdspi_fat/readme.html#downloading-and-building-the-application"
  },"76": {
    "doc": "FAT filesystem using SDSPI Media",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mk_mcm_curiosity_pro.X | PIC32MK MCM Curiosity Pro Board | . | pic32mk_mcj_curiosity_pro.X | PIC32MK MCJ Curiosity Pro Board | . | pic32mk_mca_curiosity_pro.X | PIC32MK MCA Curiosity Pro Board | . |   |   | . | To run the demo, the following additional hardware are required: . | One micro-sd card | Create a new JPEG file in the SD Card with name FILE_TOO_LONG_NAME_EXAMPLE_123.JPG | . | . Setting up PIC32MK MCJ Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer | Connect IO1 Xplained Pro Extension Kit to the EXT1 (J501) header of PIC32MK MCJ Curiosity Pro Development Board | Insert the micro-SD Card in the micro-SD Card slot of the IO1 Xplained Pro Extension Kit | . Setting up PIC32MK MCM Curiosity Pro Board . | Connect a micro USB cable to the USB DEBUG port J500 | Install micro-sd Click board on to the mikroBUS socket J300 of PIC32MK MCM Curiosity Pro Board | Insert the micro-SD Card in the micro-SD Card slot of the micro-sd Click board | . Setting up PIC32MK MCA Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector (J1) on the board to the computer | Connect IO1 Xplained Pro Extension Kit to the J501 header of PIC32MK MCA Curiosity Pro Development Board | Insert the micro-SD Card in the micro-SD Card slot of the IO1 Xplained Pro Extension Kit | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/fs/sdspi_fat/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/fs/sdspi_fat/readme.html#setting-up-the-hardware"
  },"77": {
    "doc": "FAT filesystem using SDSPI Media",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | Press Switch to start the file operations | The LED is turned ON if there was no error during creating the directory and copying the file into it | . Refer to the following table for switch and LED name: . | Board | Switch name | LED Name | . | PIC32MK MCJ Curiosity Pro Board | SW200 | LED2 | . | PIC32MK MCM Curiosity Pro Board | SW1 | LED1 | . | PIC32MK MCA Curiosity Pro Board | SW200 | LED1 | . |   |   |   | . | If LED is ON, Insert the SD Card on to your host PC | SD Card should have the file Dir1/FILE_TOO_LONG_NAME_EXAMPLE_123.JPG and should match the original image | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/fs/sdspi_fat/readme.html#running-the-application",
    "relUrl": "/apps/fs/sdspi_fat/readme.html#running-the-application"
  },"78": {
    "doc": "FAT filesystem using SDSPI Media",
    "title": "FAT filesystem using SDSPI Media",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/fs/sdspi_fat/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/rtos/freertos/basic_freertos/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/rtos/freertos/basic_freertos/readme.html#downloading-and-building-the-application"
  },"82": {
    "doc": "FreeRTOS basic",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mk_gp_db.X | PIC32MK GP Development Kit | . | pic32mk_mcj_curiosity_pro.X | [PIC32MK MCJ Curiosity Pro Board](https://www.microchip.com/en-us/development-tool/DT100113) | . | pic32mk_mcm_curiosity_pro.X | PIC32MK MCM Curiosity Pro Board | . |   |   | . Setting up PIC32MK GP Development Kit . | Connect micro USB cable to the ‘Debug USB’ connector(J12) on the board to the computer | Connect a micro USB cable to the USART-USB port J25. This will enumerate as a COM port on the PC | . Setting up [PIC32MK MCJ Curiosity Pro Board](https://www.microchip.com/en-us/development-tool/DT100113) . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer. This will enumerate as a COM port on the PC | . Setting up PIC32MK MCM Curiosity Pro Board . | Connect a micro USB cable to the USB DEBUG port J500 | Connect a micro USB cable to the USB to UART port J400. This will enumerate as a COM port on the PC | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/rtos/freertos/basic_freertos/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/rtos/freertos/basic_freertos/readme.html#setting-up-the-hardware"
  },"83": {
    "doc": "FreeRTOS basic",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera Term) on the computer. | Configure the serial port settings as follows: . Baud : 115200 . Data : 8 Bits . Parity : None . Stop : 1 Bit . Flow Control : None . | Build and program the application using its IDE. | Observe the following output on the terminal. | Enter any character on the terminal to run task3. Notice how task1 and task2 are pre-empted by task3 as task3 is of higher priority than task1 and task2. Pressing character ‘l’ or “L’ toggles the on board LED. Notice how task1 and task2 are not run when characters are entered continuously on the terminal. | Press the user switch on the board to run task4. Notice how task4 preempts all other tasks as it is of highest priority. | . Refer to the following table for LED and Switch name: . | Board | LED Name | Switch Name | . | PIC32MK GP Development Kit | LED1 | S1 | . | [PIC32MK MCJ Curiosity Pro Board](https://www.microchip.com/en-us/development-tool/DT100113) | LED1 |   | . | PIC32MK MCM Curiosity Pro Board | LED1 | SW1 | . |   |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/rtos/freertos/basic_freertos/readme.html#running-the-application",
    "relUrl": "/apps/rtos/freertos/basic_freertos/readme.html#running-the-application"
  },"84": {
    "doc": "FreeRTOS basic",
    "title": "FreeRTOS basic",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/rtos/freertos/basic_freertos/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/rtos/freertos/task_notification_freertos/readme.html#freertos-task-notification",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/rtos/freertos/task_notification_freertos/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/rtos/freertos/task_notification_freertos/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/rtos/freertos/task_notification_freertos/readme.html#downloading-and-building-the-application"
  },"88": {
    "doc": "FreeRTOS Task Notification",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mk_gp_db.X | PIC32MK GP Development Kit | . |   |   | . Setting up PIC32MK GP Development Kit . | Connect micro USB cable to the ‘Debug USB’ connector(J12) on the board to the computer | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/rtos/freertos/task_notification_freertos/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/rtos/freertos/task_notification_freertos/readme.html#setting-up-the-hardware"
  },"89": {
    "doc": "FreeRTOS Task Notification",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED toggles on success for every 500ms | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MK GP Development Kit | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/rtos/freertos/task_notification_freertos/readme.html#running-the-application",
    "relUrl": "/apps/rtos/freertos/task_notification_freertos/readme.html#running-the-application"
  },"90": {
    "doc": "FreeRTOS Task Notification",
    "title": "FreeRTOS Task Notification",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/rtos/freertos/task_notification_freertos/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#console-debug-system-service-using-uart",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#downloading-and-building-the-application"
  },"94": {
    "doc": "Console Debug System Service using UART",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mk_mcm_curiosity_pro.X | PIC32MK MCM Curiosity Pro Board | . | pic32mk_mcj_curiosity_pro.X | PIC32MK MCJ Curiosity Pro Board | . | pic32mk_mca_curiosity_pro.X | PIC32MK MCA Curiosity Pro Board | . | pic32mk_gp_db.X | PIC32MK GP Development Kit | . |   |   | . Setting up PIC32MK GP Development Kit . | Connect micro USB cable to the ‘Debug USB’ connector(J12) on the board to the computer | Connect a micro USB cable to the USART-USB port J25. This will enumerate as a COM port on the PC | . Setting up PIC32MK MCJ Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer. This will enumerate as a COM port on the PC | . Setting up PIC32MK MCM Curiosity Pro Board . | Connect a micro USB cable to the USB DEBUG port J500 | Connect a micro USB cable to the USB to UART port J400. This will enumerate as a COM port on the PC | . Setting up PIC32MK MCA Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer. This will enumerate as a COM port on the PC | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#running-the-application",
    "relUrl": "/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#running-the-application"
  },"96": {
    "doc": "Console Debug System Service using UART",
    "title": "Console Debug System Service using UART",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/system/time/sys_time_multiclient/readme.html#time-system-service-multi-client",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/system/time/sys_time_multiclient/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c/async/i2c_eeprom/readme.html#i2c-driver-asynchronous---i2c-eeprom",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c/async/i2c_eeprom/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c/async/i2c_eeprom/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html#downloading-and-building-the-application"
  },"106": {
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mk_mcm_curiosity_pro.X | PIC32MK MCM Curiosity Pro Board | . | pic32mk_mcj_curiosity_pro.X | PIC32MK MCJ Curiosity Pro Board | . | pic32mk_mca_curiosity_pro.X | PIC32MK MCA Curiosity Pro Board | . | pic32mk_gp_db.X | PIC32MK GP Development Kit | . |   |   | . | To run the demo, the following additional hardware are required: . | One EEPROM 3 Click board | . | . Setting up PIC32MK GP Development Kit . | Connect micro USB cable to the ‘Debug USB’ connector(J12) on the board to the computer | Install the EEPROM 3 Click board on to the mikroBUS socket J8 of PIC32MK GP Development Kit | . Setting up PIC32MK MCJ Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer | Install the EEPROM 3 Click board on to the mikroBUS Xplained Pro board | Connect the mikroBUS Xplained Pro board to the EXT1 header (J501) of the PIC32MK MCJ Curiosity Pro Development Board | . Setting up PIC32MK MCM Curiosity Pro Board . | Connect a micro USB cable to the USB DEBUG port J500 | Install the EEPROM 3 Click board on to the mikroBUS socket J300 of PIC32MK MCM Curiosity Pro Development Board | . Setting up PIC32MK MCA Curiosity Pro Board . | Connect a micro USB cable to the USB DEBUG port | Install the EEPROM 3 Click board on to the mikroBUS socket of PIC32MK MCA Curiosity Pro Development Board | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c/async/i2c_eeprom/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html#setting-up-the-hardware"
  },"107": {
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON when the value read from the EEPROM matched with the written value | . Refer to the following table for LED name: . | Board | LED Name | . | PIC32MK GP Development Kit | LED1 | . | PIC32MK MCJ Curiosity Pro Board | LED2 | . | PIC32MK MCM Curiosity Pro Board | LED2 | . | PIC32MK MCA Curiosity Pro Board | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c/async/i2c_eeprom/readme.html#running-the-application",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html#running-the-application"
  },"108": {
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "I2C driver asynchronous - I2C EEPROM",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mk/apps/driver/i2c/async/i2c_eeprom/readme.html",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html"
  },"109": {
    "doc": "Release notes",
    "title": "Microchip MPLAB® Harmony 3 Release Notes",
    "content": " ",
    "url": "http://localhost:4000/core_apps_pic32mk/release_notes.html#microchip-mplab-harmony-3-release-notes",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mk-family--v330",
    ...
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | PIC32MK GP Development Kit | 11 | . | PIC32MK MCJ Curiosity Pro Board | 14 | . | PIC32MK MCM Curiosity Pro Board | 11 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v5.50 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.8.0 | . | MPLAB® XC32 C/C++ Compiler v3.01 | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mk-family--v320",
    ...
    "url": "http://localhost:4000/core_apps_pic32mk/release_notes.html#harmony-3-driver-and-system-service-application-examples-for-pic32mk-family--v301",
    "relUrl": "/release_notes.html#harmony-3-driver-and-system-service-application-examples-for-pic32mk-family--v301"
  },"115": {
    "doc": "Release notes",
    "title": "Harmony 3 driver and system service application examples for PIC32MK family  v3.0.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | PIC32MK MCJ Curiosity Pro Board | 14 | . | PIC32MK MCM Curiosity Pro Board | 11 | . | PIC32MK GP Development Kit | 11 | . New Features . New features added in this release are as follows: . | Applications migrated from csp repository to this new application repository for PIC32MK development boards | . Known Issues . The current known issues are as follows: . | The following product family requires newer DFP version to be downloaded from packs server and to be used in the MPLAB project to build with MPLAB X IDE v5.4. | PIC32MK MCM/GPK Family: PIC32MK-GP_DFP v1.4.117, PIC32MK-MC_DFP v1.5.115 | . | . Development Tools . | MPLAB® X IDE v5.40 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.6.0 | . | MPLAB® XC32 C/C++ Compiler v2.41 | . ",
    "url": "http://localhost:4000/core_apps_pic32mk/release_notes.html#harmony-3-driver-and-system-service-application-examples-for-pic32mk-family--v300",
    "relUrl": "/release_notes.html#harmony-3-driver-and-system-service-application-examples-for-pic32mk-family--v300"
  },"116": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_pic32mk/release_notes.html",
    "relUrl": "/release_notes.html"
  },"117": {
    "doc": "Harmony 3 driver and system service application examples for PIC32MK family",
    "title": "Harmony 3 driver and system service application examples for PIC32MK family",
    "content": "[![MCHP](https://www.microchip.com/ResourcePackages/Microchip/assets/dist/images/logo.png)](https://www.microchip.com) # Harmony 3 driver and system service application examples for PIC32MK family MPLAB® Harmony 3 is an extension of the MPLAB® ecosystem for creating embedded firmware solutions for Microchip 32-bit SAM and PIC® microcontroller and microprocessor devices. Refer to the following links for more information. - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB® Harmony](https://www.microchip.com/mplab/mplab-harmony) - [Microchip MPLAB® Harmony Pages](https://microchip-mplab-harmony.github.io/) This repository contains the MPLAB® Harmony 3 driver and system service application examples for PIC32MK family - [Release Notes](/core_apps_pic32mk/release_notes.html) - [MPLAB® Harmony License](/core_apps_pic32mk/mplab_harmony_license.html) To clone or download these applications from Github, go to the [main page of this repository](https://github.com/Microchip-MPLAB-Harmony/core_apps_pic32mk) and then click **Clone** button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these [instructions](https://github.com/Microchip-MPLAB-Harmony/contentmanager/wiki). ## Contents Summary | Folder | Description | --- | --- | apps | Contains driver and system service example applications | docs | Contains documentation in html format for offline viewing (to be used only after cloning this repository onto a local machine). Use [github pages](https://microchip-mplab-harmony.github.io/core_apps_pic32mk/) of this repository for viewing it online. | ## Code Examples The following applications are provided to demonstrate the typical or interesting usage models of one or more peripheral libraries. | Name | Description | ---- | ----------- | [I2C driver asynchronous - I2C EEPROM](/core_apps_pic32mk/apps/driver/i2c/async/i2c_eeprom/readme.html) | This example application shows how to use the I2C driver in asynchronous mode to perform operations on the EEPROM | [I2C driver asynchronous - I2C Temp Sensor](/core_apps_pic32mk/apps/driver/i2c/async/i2c_temp_sensor/readme.html) | This example application shows how to use the I2C driver in asynchronous mode to communicate with the MCP9808 I2C based temperature sensor | [I2C driver synchronous - I2C EEPROM](/core_apps_pic32mk/apps/driver/i2c/sync/i2c_eeprom/readme.html) | This example application shows how to use the I2C driver in synchronous mode to perform operations on the EEPROM | [I2C EEPROM AT24 driver - EEPROM Read Write](/core_apps_pic32mk/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html) | This example application shows how to use the AT24 driver to perform read and write operations on AT24 series of EEPROM | [SPI Driver asynchronous - multi instance](/core_apps_pic32mk/apps/driver/spi/async/spi_multi_instance/readme.html) | This example demonstrates how to use multiple instances of the SPI driver in asynchronous mode to communicate with multiple EEPROMs | [SPI Driver asynchronous - multi slave](/core_apps_pic32mk/apps/driver/spi/async/spi_multi_slave/readme.html) | This example demonstrates how to use single instance of the SPI driver in asynchronous mode to communicate with multiple EEPROMs | [SPI Driver asynchronous - Self loopback multi client](/core_apps_pic32mk/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html) | This example demonstrates how to use the SPI driver in asynchronous mode to achieve self-loop back between multiple clients | [SPI Driver synchronous - Self loopback multi client](/core_apps_pic32mk/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html) | This example demonstrates how to use the SPI driver in synchronous mode to achieve self-loop back between multiple clients in RTOS environment | [SPI EEPROM AT25 driver - EEPROM Read Write](/core_apps_pic32mk/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html) | This example application shows how to use the AT25 driver to perform read and write operations on AT25 series of EEPROM | [USART driver asynchronous - USART echo](/core_apps_pic32mk/apps/driver/usart/async/usart_echo/readme.html) | This example echoes the received characters over the console using the USART driver in asynchronous mode | [USART driver asynchronous - USART multi instance](/core_apps_pic32mk/apps/driver/usart/async/usart_multi_instance/readme.html) | This example echoes the received characters over the two consoles using the USART driver in asynchronous mode | [USART driver synchronous - USART echo](/core_apps_pic32mk/apps/driver/usart/sync/usart_echo/readme.html) | This example echoes the received characters over the console using the USART driver in synchronous mode | [FAT filesystem using NVM Media](/core_apps_pic32mk/apps/fs/nvm_fat/readme.html) | This application shows an example of implementing a FAT disk in the device internal Flash memory | [FAT filesystem using SDSPI Media](/core_apps_pic32mk/apps/fs/sdspi_fat/readme.html) | This application shows an example of using the MPLAB Harmony File System to access and modify the contents of a SD card using the SDSPI driver and the SPI PLIB | [FreeRTOS basic](/core_apps_pic32mk/apps/rtos/freertos/basic_freertos/readme.html) | This example application demonstrates context switching between four tasks of different priorites. Two tasks run periodically while the other two tasks are event driven | [FreeRTOS Task Notification](/core_apps_pic32mk/apps/rtos/freertos/task_notification_freertos/readme.html) | This example application is to illustrate the FreeRTOS Task Notification feature which is used as a light weight binary semaphore | [Console Debug System Service using UART](/core_apps_pic32mk/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html) | This example application demonstrates the UART based console and debug system service | [Time System Service multi-client](/core_apps_pic32mk/apps/system/time/sys_time_multiclient/readme.html) | This example application demonstrates the multi-client system timer functionality | ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_pic32mk/blob/master/mplab_harmony_license.md) [![Latest release](https://img.shields.io/github/release/Microchip-MPLAB-Harmony/core_apps_pic32mk.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_pic32mk/releases/latest) [![Latest release date](https://img.shields.io/github/release-date/Microchip-MPLAB-Harmony/core_apps_pic32mk.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_pic32mk/releases/latest) [![Commit activity](https://img.shields.io/github/commit-activity/y/Microchip-MPLAB-Harmony/core_apps_pic32mk.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_pic32mk/graphs/commit-activity) [![Contributors](https://img.shields.io/github/contributors-anon/Microchip-MPLAB-Harmony/core_apps_pic32mk.svg)]() ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/core_apps_pic32mk.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/core_apps_pic32mk.svg?style=social)]() ",
    "url": "http://localhost:4000/core_apps_pic32mk/",
    "relUrl": "/"
  }
}
`;
...
var repo_name = "core_apps_pic32mk";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Harmony 3 driver and system service application examples for PIC32MK family";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/core_apps_pic32mk/assets/css/just-the-docs-' + theme + '.css');
}
