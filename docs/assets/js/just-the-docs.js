...
{"0": {
    ...
    "doc": "FreeRTOS basic",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mk_mcm_curiosity_pro.X | PIC32MK MCM Curiosity Pro Board | . | pic32mk_mcj_curiosity_pro.X | PIC32MK MCJ Curiosity Pro Board | . | pic32mk_gp_db.X | PIC32MK GP Development Kit | . |   |   | . Setting up PIC32MK GP Development Kit . | Connect micro USB cable to the ‘Debug USB’ connector(J12) on the board to the computer | . Setting up PIC32MK MCJ Curiosity Pro Board . | Connect micro USB cable to the ‘Debug USB’ connector(J1) on the board to the computer | . Setting up PIC32MK MCM Curiosity Pro Board . | Connect a micro USB cable to the USB DEBUG port J500 | . ",
